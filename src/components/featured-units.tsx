    ...
    >
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-10 py-16">
        <div className="text-center mb-10">
          <p className="text-xs tracking-[0.32em] uppercase text-gold-soft mb-3">
            Our Properties
          </p>
  ...
  return (
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {[0, 1, 2].map((i) => (
        ...
        >
          <span className="text-xs tracking-[0.3em] uppercase text-gold-soft mb-2">
            Coming Soon
          </span>
  ...
  return (
    ...
    >
      ...
      <div className="p-5 flex-1 flex flex-col">
        <div className="text-xs tracking-[0.25em] uppercase text-gold-soft mb-1">
          {unit.location}
        </div>
        <h3 className="font-serif text-xl text-cream mb-2">{unit.name}</h3>
        {unit.shortDescription && (
          <p className="text-sm text-cream/70 leading-relaxed line-clamp-2 mb-4">
            {unit.shortDescription}
          </p>
        )}
        <div className="flex items-center gap-4 text-xs text-cream/70 mt-auto pt-4 border-t border-gold/20">
          {unit.bedrooms != null && (
