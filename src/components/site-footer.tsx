...
export function SiteFooter() {
  return (
    <footer className="bg-cream-soft border-t border-line/80">
      <div className="mx-auto max-w-7xl px-6 lg:px-10 py-10 grid gap-6 md:grid-cols-3 items-center">
        <div className="flex md:justify-start justify-center">
          <Logo />
        </div>
        <div className="flex justify-center">
          <span className="signature text-4xl text-gold-deep leading-none">
            Natalie Ortega
          </span>
        </div>
